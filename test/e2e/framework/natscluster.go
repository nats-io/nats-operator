...
func (f *Framework) CreateCluster(namespace, prefix string, size int, version string, fn ...NatsClusterCustomizer) (*natsv1alpha2.NatsCluster, error) {
	...
	return f.NatsClient.NatsV1alpha2().NatsClusters(obj.Namespace).Create(context.TODO(), obj, metav1.CreateOptions{})
}
...
func (f *Framework) DeleteCluster(natsCluster *natsv1alpha2.NatsCluster) error {
	return f.NatsClient.NatsV1alpha2().NatsClusters(natsCluster.Namespace).Delete(context.TODO(), natsCluster.Name, metav1.DeleteOptions{})
}
...
func (f *Framework) UpdateCluster(natsCluster *natsv1alpha2.NatsCluster) (*natsv1alpha2.NatsCluster, error) {
	return f.NatsClient.NatsV1alpha2().NatsClusters(natsCluster.Namespace).Update(context.TODO(), natsCluster, metav1.UpdateOptions{})
}
...
func (f *Framework) PodsForNatsCluster(natsCluster *natsv1alpha2.NatsCluster) ([]v1.Pod, error) {
	pods, err := f.KubeClient.CoreV1().Pods(natsCluster.Namespace).List(context.TODO(), kubernetesutil.ClusterListOpt(natsCluster.Name))
	if err != nil {
		return nil, err
	}
...
func (f *Framework) ServicesForNatsCluster(natsCluster *natsv1alpha2.NatsCluster) ([]v1.Service, error) {
	svc, err := f.KubeClient.CoreV1().Services(natsCluster.Namespace).List(context.TODO(), kubernetesutil.ClusterListOpt(natsCluster.Name))
	if err != nil {
		return nil, err
	}
...
func (f *Framework) SecretsForNatsCluster(natsCluster *natsv1alpha2.NatsCluster) ([]v1.Secret, error) {
	secrets, err := f.KubeClient.CoreV1().Secrets(natsCluster.Namespace).List(context.TODO(), kubernetesutil.ClusterListOpt(natsCluster.Name))
	if err != nil {
		return nil, err
	}
...
func (f *Framework) PatchCluster(natsCluster *natsv1alpha2.NatsCluster) (*natsv1alpha2.NatsCluster, error) {
	...
	currentCluster, err := f.NatsClient.NatsV1alpha2().NatsClusters(natsCluster.Namespace).Get(context.TODO(), natsCluster.Name, metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
	...
	return f.NatsClient.NatsV1alpha2().NatsClusters(natsCluster.Namespace).Patch(context.TODO(), natsCluster.Name, types.MergePatchType, bytes, metav1.PatchOptions{})
}
...
func (f *Framework) WaitUntilNatsClusterCondition(ctx context.Context, natsCluster *natsv1alpha2.NatsCluster, fn watch.ConditionFunc) error {
	...
	lw := &cache.ListWatch{
		ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
			...
			return f.NatsClient.NatsV1alpha2().NatsClusters(natsCluster.Namespace).List(context.TODO(), options)
		},
		WatchFunc: func(options metav1.ListOptions) (watchapi.Interface, error) {
			options.FieldSelector = fs.String()
			return f.NatsClient.NatsV1alpha2().NatsClusters(natsCluster.Namespace).Watch(context.TODO(), options)
		},
	}
