...
func (in *ClusterSpec) DeepCopyInto(out *ClusterSpec) {
	*out = *in
	...
	if in.WebsocketConfig != nil {
		in, out := &in.WebsocketConfig, &out.WebsocketConfig
	...
	if in.ManagementServicePolicy != nil {
		in, out := &in.ManagementServicePolicy, &out.ManagementServicePolicy
		*out = new(ServicePolicy)
		(*in).DeepCopyInto(*out)
	}
	return
...
func (in *LeafNodeConfig) DeepCopyInto(out *LeafNodeConfig) {
	*out = *in
	if in.Remotes != nil {
		...
		*out = make([]LeafNodeRemote, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LeafNodeRemote) DeepCopyInto(out *LeafNodeRemote) {
	*out = *in
	if in.URLs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LeafNodeRemote.
func (in *LeafNodeRemote) DeepCopy() *LeafNodeRemote {
	if in == nil {
		return nil
	}
	out := new(LeafNodeRemote)
	in.DeepCopyInto(out)
	return out
}
