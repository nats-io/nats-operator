...
import (
	...
	nats "github.com/nats-io/nats-operator/pkg/client/informers/externalversions/nats"
...
func (f *sharedInformerFactory) Nats() nats.Interface {
	return nats.New(f, f.namespace, f.tweakListOptions)
}
